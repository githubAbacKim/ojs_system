...
--
-- Host: localhost
-- Generation Time: Jan 14, 2020 at 07:14 PM
...
--
ALTER TABLE `daily_output`
  MODIFY `dailyout_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `emp_attendance`
  MODIFY `emp_attendance_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
