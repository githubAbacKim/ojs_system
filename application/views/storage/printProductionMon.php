                ...
                <table class="table table-striped table-bordered table-hover" style="font-size:23px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:12pt;"><?php echo $item->kitchenitem_name;?></td>
                            <td style="font-size:12pt;"><?php echo $item->kitchenitem_unit;?></td>
                            <td class="text-center" style="font-size:12pt;"><?php echo $item->kitchenitem_stock;?></td>
                            <td class="text-right" style="font-size:12pt;"><?php echo $item->kitchenitem_dispose;?></td>
