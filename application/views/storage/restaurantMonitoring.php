<div class="row">
	<div class="col-lg-12" style="margin-bottom: 5px;height: 65px;">
		...
		<div class="col-lg-6">
			<a id="printList" data="<?php echo base_url('admin/printRestoMon')?>" class="btn btn-default pull pull-right" style="margin-top: 25px;">Print List</a>
		</div>			
	</div>
	<div class="col-lg-12">		
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		itemTable = $("#stockItems").DataTable({
			...
			'serverside':true,
			'ajax': {
				"url": "<?php echo site_url('admin/fetchRestaurantItem')?>",
				"type": "POST"
			},
