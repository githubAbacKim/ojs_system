<div class="col-lg-12">
      ...
      <div class="col-lg-12">
          <h2 class="page-header"><i class="fa fa-cubes fa-fw"></i> Expenses Details</h2>
              ...
              <div class="col-md-4 col-md-offset-4">
                <button type="button" id="addMisc" class="btn btn-primary">Add Misc</button>
              </div>
          </div>
      </div>
    </div>
  ...
  <div class="col-lg-7 col-xs-12">
    <div class="row">
      <div class="col-lg-12">
        <h2 class="page-header text-center">Miscellaneous Expenses</h2>
        <table class="table table-striped table-bordered table-hover" id="misc" style="font-size:10pt;">
            <thead>
                <tr>
...
<script type="text/javascript">
  ...
  miscTable = $("#misc").DataTable({
      'processing':true,
      'serverside':true,
      'ajax': {
          "url": "<?php echo site_url('production/fetchMiscExp')?>",
          "type": "POST"
      },
  ...
  $('#addMisc').click(function(){
      $('#miscForm').attr('action','<?php echo base_url("production/addMisc")?>');
      var url = $('#miscForm').attr('action');
