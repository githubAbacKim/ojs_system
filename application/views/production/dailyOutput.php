<div class="col-lg-12" style="max-height:470px;min-height:470px;">
  ...
  <div class="col-lg-5" style="max-height:470px;min-height:470px;">
    <div class="row">
      <div class="col-lg-12">
          <h2 class="page-header"><i class="fa fa-cubes fa-fw"></i> Output Details</h2>
	      		<div class="col-md-12">
              <div class="col-md-12">
              ...
              <form id="outputForm">
                <div class="form-group col-md-12">
    						...
    						<div class="form-group col-md-4">
    							...
    							<input type="number" class="form-control" id="batchnum" name="batchnum" placeholder="Batch Number" />
    						</div>
    						<div class="form-group col-md-4">
              ...
              <div class="col-md-4 col-md-offset-4">
                <button type="button" id="addOutput" class="btn btn-primary">Add Output</button>
              </div>
          </div>
      </div>
    </div>
  ...
  <div class="col-lg-7" style="max-height:470px;min-height:470px;background-color:#ececec;">
    <div class="row">
      <div class="col-lg-12">
        <h2 class="page-header text-center">Daily Output</h2>
        <table class="table table-striped table-bordered table-hover" id="output" style="font-size:10pt;">
            <thead>
                <tr>
                    <th>Date</th>
                    <th>Description</th>
...
<script type="text/javascript">
  ...
  $('#output thead th').each( function () {
      var title = $(this).text();
      $(this).html( '<input style="width:100%;font-size:12px;" type="text" placeholder="'+title+'" />' );
  } );

  outputTable = $("#output").DataTable({
      'processing':true,
      'serverside':true,
      'ajax': {
          "url": "<?php echo site_url('production/fetchOutput')?>",
          "type": "POST"
      },
  ...
  $('#addOutput').click(function(){
      $('#outputForm').attr('action','<?php echo base_url("production/addOutput")?>');
      var url = $('#outputForm').attr('action');
