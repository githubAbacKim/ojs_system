                ...
                <table class="table table-striped table-bordered table-hover" style="font-size:23px;">
                    <thead>                       
                        <tr>
                            ...
                            <th class="text-right" style="font-size:12pt;">Time In</th>
                            <th class="text-right" style="font-size:12pt;">Time Out</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-size:12pt;"><?php echo $item->time_in;?></td>
                            <td class="text-right" style="font-size:12pt;"><?php echo $item->time_out;?></td>
