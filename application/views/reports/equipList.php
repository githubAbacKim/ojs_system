            ...
            <style scope>
                ...
                <table class="table table-striped table-bordered table-hover" style="font-size:23px;">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td style="font-size:12pt;"><?php echo $item->expequip_date;?></td>
                            <td style="font-size:12pt;"><?php echo $item->expequip_desc;?></td>
                            <td style="font-size:12pt;"><?php echo $item->expequip_unit;?></td>
                            <td style="font-size:12pt;"><?php echo $item->expequip_qty;?></td>
                            <td class="text-right" style="font-size:12pt;"><?php echo $item->expequip_price;?></td>
                            <td class="text-right" style="font-size:12pt;"><?php echo $expequip_amount;?></td>
                        </tr>
                        <?php 
                                }
                        ?>
                        <tr>                            
                            ...
                            <td class="text-right" style="font-size:12pt;"><?php echo $expequip_tamount;?></td>
                        </tr>
                        <?php
                            }else{
                        ?>
