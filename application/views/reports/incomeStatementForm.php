...
<div class="container" style="margin:0;">
    ...
    <div class="row">
        ...
        <div class="col-xs-8" style="font-size: 14pt;">Gross Taxable Sales</div>
        <div class="col-xs-4 text-right" style="font-size: 14pt;font-style: italic;"><?php echo '₱'.$this->cart->format_number($gross_taxable);?></div>
        ...
        <div class="col-xs-4 text-right" style="font-size: 14pt;font-style: italic;"><?php echo $this->cart->format_number($stocks);?></div>
        ...
        <div class="col-xs-12"><h3>List of Returns</h3></div>
