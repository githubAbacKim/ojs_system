  ...
  <div class="row">
	...
	<div class="row">
      ...
      <div class="col-lg-6">
		...
		<div class="col-lg-12">
	        <table class="table table-striped table-bordered table-hover" id="branchStocks" style="min-height: 150px !important;">
	        	<thead>
	                <tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#conOPrint').click(function(){
	      ...
	      var url = '<?php echo base_url('admin/printBranchStock')?>/'  + date2.val() + '/' + branch2.val();
