                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-xs-5 text-left">
                            <div><i class="fa fa-calendar"></i><strong> Month:</strong> <label style="text-indent: 10px;"><?php echo date("F");?></label></div>
                        </div>                        
                        <div class="col-lg-4 col-md-4 col-xs-5 text-left">
                            <div><i class="fa fa-calendar"></i><strong> Year:</strong>  <label style="text-indent: 10px;"><?php echo date("Y");?></label></div>
                        </div>   
                    </div>
                </div>
            </div>
