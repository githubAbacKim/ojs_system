                ...
                <table class="table table-striped table-bordered table-hover" style="font-size:11px;">
                    <thead>                       
                        <tr >
                            ...
                            <th class="text-center">Actual Stocks</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                       ...
                       <tr>
                           ...
                           <td width="15%"><?php echo $value->stockCat_name;?></td>
                           <td width="35%"><?php echo $value->stock_name;?></td>
                           <td width="10%"><?php echo $value->stock_unit;?></td>
                           <td width="10%"></td>
                           <td width="10%"></td>
                       <?php
                                }
